...
export function languageForFile(uri: string): AutocompleteLanguageInfo {
  return LANGUAGES[uri.split(".").slice(-1)[0]] || Typescript; // TODO ensure will work will all URIs
}
